...
(function() {
	...
	angular.module('app.vesselHistory').config(vesselHistoryRouteConfig);

	function vesselHistoryRouteConfig($stateProvider, $urlRouterProvider,
			$locationProvider) {
		...
		$stateProvider
				.state(
						'app.vesselHistory',
						{
							...
							views : {
								'module@app' : {
									templateUrl : 'src/main/vesselHistory/vesselHistory.html',
									controller : 'vesselHistoryController as vesselHistory'
								}
							},
							data : {
