(function ()
{
	...
	angular
		...
		.config(detailsPlanApprovalRouteConfig);
	
	function detailsPlanApprovalRouteConfig($stateProvider, $urlRouterProvider, $locationProvider){
        
        $stateProvider
        .state('app.audit.detailsPlanApproval', {
          url: "/detailsPlanApproval",
          params : {'openForCar':null, 'page':null},
          
          views    : {
        	  'auditContent@app.audit'                       : {
                  templateUrl: 'src/main/audit/detailsPlanApproval/detailsPlanApproval.html',
                  controller : 'DetailsControllerPlanApproval as det'
              }
          },
