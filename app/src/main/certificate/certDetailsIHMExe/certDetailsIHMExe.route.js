...
(function ()
{
    ...
    angular
        ...
        .config(certificateDetailsIhmExeRouteConfig);
    
   
    function certificateDetailsIhmExeRouteConfig($stateProvider, $urlRouterProvider, $locationProvider)
    {
    	
   
    	$stateProvider
        .state('app.certificate.detailsihmExe', {
          url: "/details_ihm_Exe",
          params : {'certificate':null,'logout':null},
         
          views    : {
              'certContent@app.certificate'                      : {
                  templateUrl: 'src/main/certificate/certDetailsIHMExe/certDetailsIHMExe.html',
                  controller : 'CertificateDetailsControllerIhmExe as certDetails'
              }
          },
          data: {pageTitle: 'Exemption Certificate Details', pageModule: 'Certificate Generate'},
